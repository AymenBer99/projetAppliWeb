...
<body class="head">
  ...
  <form class="center" action="AjouterMesureGouv" method="post">
          <table class="center padding-bottom margin-bottom">
            <tr>
              <td><p class="text-left">Titre</p></td>
              <td><input id="titre" type="text" name="titre" required placeholder="Titre"></td>
            </tr>
            <tr>
          ...
          <button class="btn btn-success margin-bottom" type="submit" name="submit" id="submit">Ajouter Mesure</button>
        </form>
