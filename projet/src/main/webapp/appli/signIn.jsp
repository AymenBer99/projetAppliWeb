...
<body class="head">
  ...
  <div class="body text-white padding-bottom padding-top">
    ...
    <hr class="padding-bottom">
      <div class="Connexion">
        <h2 class="center display-3 title">Connexion</h2>
        <form class="center" action="Connexion" method="post">
          <table class="center padding-bottom margin-bottom">
            <tr>
              <td><p class="text-left">Adresse mail</p></td>
              <td><input id="email" type="email" name="email" required placeholder="email@domain.com"></td>
            </tr>
            <tr>
              <td><p class="text-left">Mot de passe</p></td>
              <td><input id="mdp" type="password" name="mdp" required placeholder="Mot de passe"></td>
            </tr>
          </table>
          <button class="btn btn-success margin-bottom" type="submit" name="submit" id="submit">Se Connecter</button>
        </form>
        <td><p class="text-center">Vous n'avez pas de compte ? <p class="text-center"><u>  <a class="nav-link" href="/projet/Inscription">Inscription</a></u></p></p></td>
      </div>
      <hr class="padding-bottom">
